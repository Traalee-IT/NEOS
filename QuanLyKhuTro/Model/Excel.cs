...
namespace QuanLyKhuTro.Model
{
    public class Excel
    {
        ...
        public static void ExportFilePaymentHistoryByRoom(DataTable dataTable, string sheetName, string title)
        {
            ...
            cl6.Value2 = "Thanh toán";
            // Thiết lập màu chữ
            cl6.Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.Red);
